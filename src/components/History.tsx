...
export default function History() {
  const timeline = [
    { year: "1976", title: "Fundação", desc: "Juan Muzzi funda a Imaplast Indústria de Moldes, base para décadas de inovação." },
    { year: "1998", title: "O PDL", desc: "Início do Projeto de Desenvolvimento Limpo (PDL) e pesquisas com injeção de polímeros." },
    { year: "2008", title: "Engenharia", desc: "Conclusão do molde industrial de 7 toneladas para a injeção do quadro monobloco." },
    { year: "2009", title: "Certificação", desc: "Aprovação em testes rigorosos de resistência (3.5 ton) e selo INMETRO." },
    { year: "Hoje", title: "Inovação", desc: "Produção global com blendas de PET, Nylon e materiais orgânicos da fotossíntese." }
  ];
    ...
    <section id="history" className="max-w-7xl mx-auto px-6 sm:px-8 py-20">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
        <div className="lg:col-span-12 xl:col-span-5">
          <h2 className="text-4xl sm:text-5xl font-medium tracking-tighter font-geist mb-8">Nossa História</h2>
      ...
      <div className="pt-20 border-t border-black/5">
        <div className="max-w-2xl mb-12">
          <span className="text-brand-blue font-bold uppercase tracking-widest text-[10px] mb-4 block">Expansão Global</span>
          <h3 className="text-3xl font-medium font-geist tracking-tighter">Presença em mais de 40 países</h3>
          <p className="text-black/50 font-geist mt-4">Nossa tecnologia disruptiva já cruzou oceanos. Das Américas à Europa, cada ponto no mapa representa uma comunidade pedalando em direção ao futuro da mobilidade sustentável.</p>
        </div>
        ...
        <div className="relative h-[500px] lg:h-[600px] rounded-[3rem] bg-gray-50 border border-black/5 overflow-hidden">
          ...
          <div className="absolute bottom-8 left-8 right-8 flex flex-wrap gap-4 pointer-events-none">
            <div className="px-4 py-2 bg-white/80 backdrop-blur-md rounded-xl border border-black/5 text-[10px] font-bold text-black/40 uppercase tracking-widest">
              Garantia Vitalícia Global
            </div>
            <div className="px-4 py-2 bg-white/80 backdrop-blur-md rounded-xl border border-black/5 text-[10px] font-bold text-black/40 uppercase tracking-widest">
              Certificação Europeia (CE)
            </div>
          </div>
        </div>
      </div>
