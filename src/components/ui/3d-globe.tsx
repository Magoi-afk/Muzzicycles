    ...
    <group ref={groupRef} visible={isVisible}>
      ...
      <group ref={imageGroupRef} position={topPosition}>
        ...
        >
          <div
            className={cn(
              "cursor-pointer overflow-hidden rounded-full bg-neutral-900 shadow-lg transition-transform duration-200 ring-1 ring-white/20",
              hovered && "scale-125 shadow-xl ring-2 ring-brand-blue",
            )}
            style={{
              width: "12px",
              height: "12px",
